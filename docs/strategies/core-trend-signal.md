# Core Trend Signal — SMA 200 + ATR Buffer (Layer 1)

[← Back to README](../../README.md) · Related: [Methodology](methodology.md) · [Dual-Signal Agreement](dual-signal-agreement.md) · [Trailing Stop](trailing-stop.md)

This is the foundation layer of the bot. Each index's trend is classified against a 200-day Simple Moving Average with a volatility buffer sized by **Average True Range (ATR)** — "breathing room" that widens in volatile markets and tightens in calm ones, so the strategy adapts instead of reacting to every minor wiggle:
...
The rest of the system layers a noise filter ([dual-signal agreement](dual-signal-agreement.md)) and a crash filter ([trailing stop](trailing-stop.md)) on top of this base signal.

---

## Backtest Results

All tables use the rolling 26-year methodology described in [Methodology](methodology.md). These three tables compare the core trend strategies (SMA 200 vs EMA 50/200 vs Buy & Hold vs VIX/RSI) across signal sources and leverage tiers.
...
- [Optimization analysis (2026-07-27)](../optimization-analysis-2026-07-27.md) — parameter selection for the SMA/ATR core.
- [Out-of-sample validation (2026-07-28)](../out-of-sample-validation-2026-07-28.md) — generalization of the core trend signal.
