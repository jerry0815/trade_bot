...
_CAVEATS = (
    ...
    "> ⚠️ **Negative result.** After fixing two backtesting bugs (a 1-day sleeve "
    "lookahead and a strike-selection-vs-pricing vol mismatch), **no options overlay "
    "beats the bare Trend model** — here or over the full 1990–2026 history, on the "
    "single-signal or the production sleeve, at any strike. The options models below "
    "(covered calls, dynamic) trail Trend; the collar (not shown) is net-negative. "
    "Earlier 'collar wins' write-ups were a pricing artifact. See "
    "`docs/strategies/options-overlay.md`.\n\n"
