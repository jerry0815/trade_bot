...
_CAVEATS = (
    ...
    "> ⚠️ **This is the 2018–2026 window, which had no prolonged bear — it is "
    "crash-light.** Covered calls lead here, but that lead does *not* survive a "
    "fast leveraged crash: over the full 1990–2026 history (which includes the fast "
    "April-2000 dot-com crash), covered calls fall *below* plain Trend and only the "
    "collar — with a real protective put — beats it. See "
    "`docs/options-overlay-extended-2001.md` and "
    "`docs/strategies/options-overlay.md` for the full-history result.\n\n"
